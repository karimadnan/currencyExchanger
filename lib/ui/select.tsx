...
import { cn } from "../util"
import ExpandMore from '../../public/icons/expand-more-icon.svg'
import ExpandLess from '../../public/icons/expand-less-icon.svg'
import Done from '../../public/icons/done-icon.svg'
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-blue-500 focus:text-white focus:fill-white data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
    {...props}
  >
